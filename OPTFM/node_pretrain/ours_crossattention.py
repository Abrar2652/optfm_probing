...
class SGFormer_MIP(nn.Module):
    ...
    def forward(self, cons_x, edge_index, edge_attr, var_x):
        ...
        var_emb = self.trans_conv_cross_constovar(var_emb, cons_emb, sparse_matrix.to_dense().t())
        cons_emb = self.trans_conv_cross_vartocons(cons_emb, var_emb, sparse_matrix.to_dense())
